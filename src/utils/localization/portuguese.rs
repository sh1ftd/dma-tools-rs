...
pub fn get_text(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::MissingFilesWarning => "AVISO: Continuar sem os arquivos necessários pode causar erros",
        ...
        TextKey::PlaceFirmwareHere => "Por favor, coloque arquivos de firmware .bin no diretório da aplicação",
        ...
        TextKey::NoteFewerSectors => "Nota: Operação concluída com menos de 10 setores. Por favor, verifique manualmente ou tente novamente.",
        TextKey::NoteVerifySuccess => "Nota: Não foi possível verificar o sucesso completo, mas nenhum erro foi detectado. Por favor, verifique manualmente ou tente novamente.",
        ...
        TextKey::PleaseWaitDna => "Por favor, aguarde enquanto recuperamos o ID único do seu dispositivo.",
        TextKey::DnaTakesSeconds => "Isso normalmente leva alguns segundos para concluir.",
        TextKey::FlashingFirmware => "Gravando Firmware",
        TextKey::PleaseWaitFlash => "Por favor, aguarde enquanto o firmware está sendo gravado no seu dispositivo.",
        TextKey::FlashTakesMinutes => "Isso normalmente leva 1-2 minutos para concluir.",
        TextKey::FlashFailImmediate => "Se o processo for concluído imediatamente, provavelmente falhou.",
        ...
        TextKey::DnaInfoNotFound => "Não foi possível encontrar informações de DNA no arquivo de saída",
