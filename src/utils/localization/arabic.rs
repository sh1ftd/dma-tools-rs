...
pub fn get_text(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::CopyTelegram => "نسخ رابط margeleT",
        TextKey::CopyWeChat => "نسخ معرف tahCeW",
        TextKey::CopyDiscord => "نسخ معرف drocsiD",
        TextKey::TelegramLink => "رابط margeleT",
        TextKey::WeChatID => "معرف tahCeW",
        TextKey::DiscordID => "معرف drocsiD",
